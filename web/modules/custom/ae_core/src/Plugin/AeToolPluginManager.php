...
use Drupal\ae_core\Annotation\AeToolPlugin;
 ...
 * and more.
 */
class AeToolPluginManager extends DefaultPluginManager implements AePluginInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $plugin_definition_annotation_name = AeToolPlugin::class;
    ...
    // thus: hook_ae_tool_info_alter().
    $this->alterInfo('ae_tool_info');

    // This sets the caching method for our plugin definitions.
    $this->setCacheBackend($cache_backend, 'ae_tool_info');
  }
