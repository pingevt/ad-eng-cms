...
use Drupal\ae_core\Annotation\AeArmorPlugin;
 ...
 * and more.
 */
class AeArmorPluginManager extends DefaultPluginManager implements AePluginInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $plugin_definition_annotation_name = AeArmorPlugin::class;
    ...
    // thus: hook_ae_armor_info_alter().
    $this->alterInfo('ae_armor_info');

    // This sets the caching method for our plugin definitions.
    $this->setCacheBackend($cache_backend, 'ae_armor_info');
  }
