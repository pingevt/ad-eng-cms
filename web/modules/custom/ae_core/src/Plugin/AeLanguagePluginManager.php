...
namespace Drupal\ae_core\Plugin;

use Drupal\ae_core\Annotation\AeLanguagePlugin;
 ...
 * and more.
 */
class AeLanguagePluginManager extends DefaultPluginManager implements AePluginInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $plugin_interface = AePluginInterface::class;

    // The name of the annotation class that contains the plugin definition.
    $plugin_definition_annotation_name = AeLanguagePlugin::class;
    ...
    // thus: hook_ae_language_info_alter().
    $this->alterInfo('ae_language_info');

    // This sets the caching method for our plugin definitions.
    $this->setCacheBackend($cache_backend, 'ae_language_info');
  }
