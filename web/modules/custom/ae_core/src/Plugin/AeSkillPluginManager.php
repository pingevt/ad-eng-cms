...
use Drupal\ae_core\Annotation\AeSkillPlugin;
 ...
 * and more.
 */
class AeSkillPluginManager extends DefaultPluginManager implements AePluginInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $plugin_definition_annotation_name = AeSkillPlugin::class;
    ...
    // thus: hook_ae_skill_info_alter().
    $this->alterInfo('ae_skill_info');

    // This sets the caching method for our plugin definitions.
    $this->setCacheBackend($cache_backend, 'ae_skill_info');
  }
