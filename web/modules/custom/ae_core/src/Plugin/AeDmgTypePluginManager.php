...
use Drupal\ae_core\Annotation\AeDmgTypePlugin;
 ...
 * and more.
 */
class AeDmgTypePluginManager extends DefaultPluginManager implements AePluginInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $plugin_definition_annotation_name = AeDmgTypePlugin::class;
    ...
    // thus: hook_ae_dmg_type_info_alter().
    $this->alterInfo('ae_dmg_type_info');

    // This sets the caching method for our plugin definitions.
    $this->setCacheBackend($cache_backend, 'ae_dmg_type_info');
  }
