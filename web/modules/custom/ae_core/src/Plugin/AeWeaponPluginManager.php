...
use Drupal\ae_core\Annotation\AeWeaponPlugin;
 ...
 * and more.
 */
class AeWeaponPluginManager extends DefaultPluginManager implements AePluginInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $plugin_definition_annotation_name = AeWeaponPlugin::class;
    ...
    // thus: hook_ae_weapon_info_alter().
    $this->alterInfo('ae_weapon_info');

    // This sets the caching method for our plugin definitions.
    $this->setCacheBackend($cache_backend, 'ae_weapon_info');
  }
